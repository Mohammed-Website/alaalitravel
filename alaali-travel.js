        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/alaalitravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-العالي/عروض-تايلاند/عرض-تايلاند-1.jpg', 'الرحلات الفردية'],
        image_2: ['عروض-شركة-العالي/عروض-تايلاند/عرض-تايلاند-2.jpg', 'الرحلات الفردية'],
        image_3: ['عروض-شركة-العالي/عروض-تايلاند/عرض-تايلاند-3.jpg', 'الرحلات الفردية'],
        image_4: ['عروض-شركة-العالي/عروض-تايلاند/عرض-تايلاند-4.jpg', 'الرحلات الفردية'],
    },

    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-العالي/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'الرحلات الجماعية'],
        image_2: ['عروض-شركة-العالي/عروض-اذربيجان/عرض-اذربيجان-2.jpg', 'الرحلات الجماعية'],
        image_3: ['عروض-شركة-العالي/عروض-اذربيجان/عرض-اذربيجان-3.jpg', 'الرحلات الجماعية'],
    },
    
    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-العالي/عروض-لندن/عرض-لندن-1.jpg', 'الرحلات الفردية'],
        image_2: ['عروض-شركة-العالي/عروض-لندن/عرض-لندن-2.jpg', 'الرحلات الفردية'],
        image_3: ['عروض-شركة-العالي/عروض-لندن/عرض-لندن-3.jpg', 'الرحلات الفردية'],
        image_4: ['عروض-شركة-العالي/عروض-لندن/عرض-لندن-4.jpg', 'الرحلات الفردية'],
    },


    {
        title: 'عروض موسكو',
        image_1: ['عروض-شركة-العالي/عروض-موسكو/عرض-موسكو-1.jpg', 'الرحلات الفردية'],
        image_2: ['عروض-شركة-العالي/عروض-موسكو/عرض-موسكو-2.jpg', 'الرحلات الفردية'],
        image_3: ['عروض-شركة-العالي/عروض-موسكو/عرض-موسكو-3.jpg', 'الرحلات الفردية'],
    },


    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-العالي/عروض-اسطنبول/عرض-اسطنبول-1.jpg', 'الرحلات الفردية'],
        image_2: ['عروض-شركة-العالي/عروض-اسطنبول/عرض-اسطنبول-2.jpg', 'الرحلات الفردية'],
        image_3: ['عروض-شركة-العالي/عروض-اسطنبول/عرض-اسطنبول-3.jpg', 'الرحلات الفردية'],
    },

    {
        title: 'عروض دبي',
        image_1: ['عروض-شركة-العالي/عروض-دبي/عرض-دبي-1.jpg', 'الرحلات الفردية'],
        image_2: ['عروض-شركة-العالي/عروض-دبي/عرض-دبي-2.jpg', 'الرحلات الفردية'],
        image_3: ['عروض-شركة-العالي/عروض-دبي/عرض-دبي-3.jpg', 'الرحلات الفردية'],
        image_4: ['عروض-شركة-العالي/عروض-دبي/عرض-دبي-4.jpg', 'الرحلات الفردية'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97339004446?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/alaalitravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة العالي على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة العالي على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة العالي على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة العالي للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة العالي للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة العالي`;
            img.title = `مكتب سياحي - شركة العالي`;
